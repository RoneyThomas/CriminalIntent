...
/**
 * Created by roneythomas on 2016-06-08.
 */

public class DatePickerFragment extends DialogFragment {

    public static final String EXTRA_DATE = "com.example.roneythomas.criminalintent.date";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDatePicker = (DatePicker) v.findViewById(R.id.dialog_date_date_pick);
